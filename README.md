...
1. 选择域名注册服务商。     
   ...
   国际域名注册服务商有 GoDaddy,国内有万网（阿里云）、腾讯云。本人用的是阿里云注册的，以下教程也将以在阿里云上申请域名为例。    
   
2. 申请域名。  


   *  打开[阿里云官网]( https://www.aliyun.com/)，并登陆。     
  
   *  在右上角选择「全部导航」-「产品」-「域名与网站」，点击「域名与网站」进入。
   
   *  输入你要注册的域名,查询是否已被申请。若未注册，选择「加入清单」并支付，然后填写个人信息。若已被注册，则只能改一个。
